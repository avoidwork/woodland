...
const path = require("path"),
	...
	{all, clone, each, http2Normalize, http2Send, next, params, parse, partial, pipeable, last, reduce, wrapped, writeHead} = require(path.join(__dirname, "utility.js")),
	delimiter = ":";
...
class Woodland extends Base {
	...
	allows (uri, override = false) {
		...
		if (override === true || result === void 0) {
			const list = this.methods.filter(i => this.allowed(i, uri, override) === true);
